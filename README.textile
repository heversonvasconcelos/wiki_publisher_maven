h1. Redmine Publisher

{{>TOC}}

h2. DESCRIÇÃO

O Redmine Publisher é um plugin do Maven 2 que tem como objetivo auxiliar a publicação
...
* publish-wiki
> Publica a documentação do projeto na Wiki do Redmine. O Redmine Publisher irá exportar o conteúdo do diretório configurado na tag <designDir> (seção de configurações do plugin no pom.xml), para páginas wiki.
