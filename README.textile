...
O Redmine Wiki Publisher é um plugin do Maven 2 que tem como objetivo auxiliar a publicação
...
O Redmine Wiki Publisher foi desenvolvido por uma equipe da DIDE - Divisão de Desenvolvimento
...
* publish-wiki
> Publica a documentação do projeto na Wiki do Redmine. O Redmine Wiki Publisher irá exportar o conteúdo do diretório configurado na tag <designDir> (seção de configurações do plugin no pom.xml), para páginas wiki.

h3. Como executar

* publish-wiki
<pre>
mvn redmine-wiki-publisher:publish-wiki
</pre>
